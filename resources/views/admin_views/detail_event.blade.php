                ...
                <div class="tab-pane fade document-link-wrapper bg-white p-2" data-cy="wrapper-document-link"
                    ...
                    @if ($count > 0)
                        <div class="draw-section mb-4 p-4 position-relative overflow-hidden"
                            ...
                            @if ($unpaidCount > 0)
                                <div class="alert alert-warning d-flex align-items-center mb-4 position-relative"
                                    role="alert"
                                    style="background: linear-gradient(135deg, #fff3cd 0%, #ffe69c 100%); 
                                            border: 2px solid #ffc107; 
                                            border-radius: 15px; 
                                            box-shadow: 0 4px 15px rgba(255, 193, 7, 0.3);">
                                    <i class="ri-alert-line me-3" style="font-size: 2rem; color: #856404;"></i>
                                    <div>
                                        <h6 class="alert-heading mb-1 fw-bold" style="color: #856404;">
                                            <i class=""></i>

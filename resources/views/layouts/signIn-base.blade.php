...
<body>
    ...
    <section class="login row justify-content-between">
        <div class="content-left col-lg-7 d-none d-lg-block h-100"
            style="
                ...
                <div class="border-2 signin-box p-3 p-sm-4 rounded rounded-5 col-10 col-md-7 col-lg-8">
                    <div class="header">
                        <div class="text-center">
                            <img src="{{ asset('img/logos.png') }}" alt="Logo KP Bintang Jaya Malang"
                                class="signin-logo mb-3" />
                        ...
                        <div class="login-form d-flex flex-column gap-1 gap-lg-3 mt-3">
                            ...
                            <div class="password-container position-relative">
                                <div class="pass-wrapper">
                                    <input name="password" data-cy="input-password" type="password" class="form-control"
...
<script>
    ...
    $('.pass-icon').click(function(e) {
        ...
        $('#password').prop("type") == 'password' ? $('#password').attr('type', 'text') : $('#password').attr(
            'type', 'password');
    });
</script>
